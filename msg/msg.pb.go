...
type Seqs struct {
	...
	MaxSeq     int64 `protobuf:"varint,1,opt,name=maxSeq,proto3" json:"maxSeq"`         // 最大序列号
	HasReadSeq int64 `protobuf:"varint,2,opt,name=hasReadSeq,proto3" json:"hasReadSeq"` // 已读序列号
}
...
type GetConversationsHasReadAndMaxSeqResp struct {
	...
	Seqs map[string]*Seqs `protobuf:"bytes,1,rep,name=seqs,proto3" json:"seqs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 对话与序列号的映射
}
...
type GetActiveUserReq struct {
	...
	Ase        bool                     `protobuf:"varint,3,opt,name=ase,proto3" json:"ase"`              // 是否按时间排序
	Group      bool                     `protobuf:"varint,4,opt,name=group,proto3" json:"group"`          // 是否为群组
	Pagination *sdkws.RequestPagination `protobuf:"bytes,5,opt,name=pagination,proto3" json:"pagination"` // 分页信息
}
...
type ActiveUser struct {
	...
	User  *sdkws.UserInfo `protobuf:"bytes,1,opt,name=user,proto3" json:"user"`    // 用户信息
	Count int64           `protobuf:"varint,2,opt,name=count,proto3" json:"count"` // 活跃次数
}
...
type GetActiveUserResp struct {
	...
	MsgCount  int64            `protobuf:"varint,1,opt,name=msgCount,proto3" json:"msgCount"`                                                                                           // 消息总数
	UserCount int64            `protobuf:"varint,2,opt,name=userCount,proto3" json:"userCount"`                                                                                         // 用户总数
	DateCount map[string]int64 `protobuf:"bytes,3,rep,name=dateCount,proto3" json:"dateCount,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 按日期统计的活跃用户数
	Users     []*ActiveUser    `protobuf:"bytes,4,rep,name=users,proto3" json:"users"`                                                                                                  // 活跃用户列表
}
...
type GetActiveGroupReq struct {
	...
	End        int64                    `protobuf:"varint,2,opt,name=end,proto3" json:"end"`              // 结束时间
	Ase        bool                     `protobuf:"varint,3,opt,name=ase,proto3" json:"ase"`              // 是否按时间排序
	Pagination *sdkws.RequestPagination `protobuf:"bytes,4,opt,name=pagination,proto3" json:"pagination"` // 分页信息
}
...
type ActiveGroup struct {
	...
	Group *sdkws.GroupInfo `protobuf:"bytes,1,opt,name=group,proto3" json:"group"`  // 群组信息
	Count int64            `protobuf:"varint,2,opt,name=count,proto3" json:"count"` // 活跃次数
}
...
type GetActiveGroupResp struct {
	...
	MsgCount   int64            `protobuf:"varint,1,opt,name=msgCount,proto3" json:"msgCount"`                                                                                           // 消息总数
	GroupCount int64            `protobuf:"varint,2,opt,name=groupCount,proto3" json:"groupCount"`                                                                                       // 群组总数
	DateCount  map[string]int64 `protobuf:"bytes,3,rep,name=dateCount,proto3" json:"dateCount,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 按日期统计的活跃群组数
	Groups     []*ActiveGroup   `protobuf:"bytes,4,rep,name=groups,proto3" json:"groups"`                                                                                                // 活跃群组列表
}
...
type SearchMessageReq struct {
	...
	ContentType int32                    `protobuf:"varint,3,opt,name=contentType,proto3" json:"contentType"` // 消息内容类型
	SendTime    string                   `protobuf:"bytes,4,opt,name=sendTime,proto3" json:"sendTime"`        // 发送时间
	SessionType int32                    `protobuf:"varint,5,opt,name=sessionType,proto3" json:"sessionType"` // 会话类型
	Pagination  *sdkws.RequestPagination `protobuf:"bytes,6,opt,name=pagination,proto3" json:"pagination"`    // 分页信息
}
...
type SearchMessageResp struct {
	...
	ChatLogs    []*ChatLog `protobuf:"bytes,1,rep,name=chatLogs,proto3" json:"chatLogs"`        // 消息日志列表
	ChatLogsNum int32      `protobuf:"varint,2,opt,name=chatLogsNum,proto3" json:"chatLogsNum"` // 消息日志数量
}
...
type ChatLog struct {
	...
	SendID           string `protobuf:"bytes,3,opt,name=sendID,proto3" json:"sendID"`                       // 发送者ID
	RecvID           string `protobuf:"bytes,4,opt,name=recvID,proto3" json:"recvID"`                       // 接收者ID
	GroupID          string `protobuf:"bytes,5,opt,name=groupID,proto3" json:"groupID"`                     // 群组ID
	RecvNickname     string `protobuf:"bytes,6,opt,name=recvNickname,proto3" json:"recvNickname"`           // 接收者昵称
	SenderPlatformID int32  `protobuf:"varint,7,opt,name=senderPlatformID,proto3" json:"senderPlatformID"`  // 发送者平台ID
	SenderNickname   string `protobuf:"bytes,8,opt,name=senderNickname,proto3" json:"senderNickname"`       // 发送者昵称
	SenderFaceURL    string `protobuf:"bytes,9,opt,name=senderFaceURL,proto3" json:"senderFaceURL"`         // 发送者头像URL
	GroupName        string `protobuf:"bytes,10,opt,name=groupName,proto3" json:"groupName"`                // 群组名称
	SessionType      int32  `protobuf:"varint,11,opt,name=sessionType,proto3" json:"sessionType"`           // 会话类型
	MsgFrom          int32  `protobuf:"varint,12,opt,name=msgFrom,proto3" json:"msgFrom"`                   // 消息来源
	ContentType      int32  `protobuf:"varint,13,opt,name=contentType,proto3" json:"contentType"`           // 消息内容类型
	Content          string `protobuf:"bytes,14,opt,name=content,proto3" json:"content"`                    // 消息内容
	Status           int32  `protobuf:"varint,15,opt,name=status,proto3" json:"status"`                     // 消息状态
	SendTime         int64  `protobuf:"varint,16,opt,name=sendTime,proto3" json:"sendTime"`                 // 发送时间
	CreateTime       int64  `protobuf:"varint,17,opt,name=createTime,proto3" json:"createTime"`             // 创建时间
	Ex               string `protobuf:"bytes,18,opt,name=ex,proto3" json:"ex"`                              // 扩展字段
	GroupFaceURL     string `protobuf:"bytes,19,opt,name=groupFaceURL,proto3" json:"groupFaceURL"`          // 群组头像URL
	GroupMemberCount uint32 `protobuf:"varint,20,opt,name=groupMemberCount,proto3" json:"groupMemberCount"` // 群组成员数量
	Seq              int64  `protobuf:"varint,21,opt,name=seq,proto3" json:"seq"`                           // 序列号
	GroupOwner       string `protobuf:"bytes,22,opt,name=groupOwner,proto3" json:"groupOwner"`              // 群组拥有者
	GroupType        int32  `protobuf:"varint,23,opt,name=groupType,proto3" json:"groupType"`               // 群组类型
}
...
type BatchSendMessageReq struct {
	...
	RecvIDList []string       `protobuf:"bytes,1,rep,name=recvIDList,proto3" json:"recvIDList"` // 接收者ID列表
	MsgData    *sdkws.MsgData `protobuf:"bytes,2,opt,name=msgData,proto3" json:"msgData"`       // 消息数据
}
...
type GetServerTimeResp struct {
	...
	ServerTime int64 `protobuf:"varint,1,opt,name=serverTime,proto3" json:"serverTime"` // 服务器时间
}
...
type ClearMsgReq struct {
	...
	Timestamp int64 `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp"` // 时间戳
}
...
var file_msg_msg_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x22, 0x86, 0x01, 0x0a,
	0x12, 0x4d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x54, 0x6f, 0x4d, 0x6f, 0x6e, 0x67, 0x6f, 0x42,
	0x79, 0x4d, 0x51, 0x12, 0x18, 0x0a, 0x07, 0x6c, 0x61, 0x73, 0x74, 0x53, 0x65, 0x71, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x6c, 0x61, 0x73, 0x74, 0x53, 0x65, 0x71, 0x12, 0x26, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x49, 0x44, 0x12, 0x2e, 0x0a, 0x07, 0x6d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x73,
	...
	0x28, 0x03, 0x52, 0x06, 0x4d, 0x69, 0x6e, 0x53, 0x65, 0x71, 0x22, 0x3c, 0x0a, 0x0a, 0x53, 0x65,
	0x6e, 0x64, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x12, 0x2e, 0x0a, 0x07, 0x6d, 0x73, 0x67, 0x44,
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x65, 0x74, 0x69,
	0x6d, 0x2e, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2e, 0x4d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x52,
	0x07, 0x6d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x22, 0x6d, 0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64,
	...
	,
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x26,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x22, 0x0c, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x4d, 0x73, 0x67,
	0x73, 0x52, 0x65, 0x71, 0x22, 0x0d, 0x0a, 0x0b, 0x44, 0x65, 0x6c, 0x4d, 0x73, 0x67, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x22, 0x60, 0x0a, 0x0c, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x4d, 0x73, 0x67,
	...
	0x65, 0x71, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x73, 0x65, 0x71, 0x12, 0x16, 0x0a,
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75,
	0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x0f, 0x0a, 0x0d, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x4d,
	0x73, 0x67, 0x52, 0x65, 0x73, 0x70, 0x22, 0x67, 0x0a, 0x11, 0x4d, 0x61, 0x72, 0x6b, 0x4d, 0x73,
	0x67, 0x73, 0x41, 0x73, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x71, 0x12, 0x26, 0x0a, 0x0e, 0x63,
	...
	0x14, 0x0a, 0x12, 0x4d, 0x61, 0x72, 0x6b, 0x4d, 0x73, 0x67, 0x73, 0x41, 0x73, 0x52, 0x65, 0x61,
	0x64, 0x52, 0x65, 0x73, 0x70, 0x22, 0x8f, 0x01, 0x0a, 0x19, 0x4d, 0x61, 0x72, 0x6b, 0x43, 0x6f,
	...
	0x53, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x65, 0x71, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x03, 0x52, 0x04, 0x73, 0x65, 0x71, 0x73, 0x22, 0x1c, 0x0a, 0x1a, 0x4d, 0x61, 0x72, 0x6b, 0x43,
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x73, 0x52, 0x65, 0x61,
	0x64, 0x52, 0x65, 0x73, 0x70, 0x22, 0x7e, 0x0a, 0x1c, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x76,
	...
	,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x3e, 0x0a, 0x0d, 0x64, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x4f, 0x70, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x18, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x44, 0x65, 0x6c, 0x65,
	...
	0x67, 0x52, 0x65, 0x73, 0x70, 0x22, 0x6c, 0x0a, 0x12, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6c, 0x65,
	...
	0x72, 0x49, 0x44, 0x12, 0x3e, 0x0a, 0x0d, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x79, 0x6e,
	0x63, 0x4f, 0x70, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x61, 0x65, 0x74,
	0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x79, 0x6e,
	...
	0x41, 0x6c, 0x6c, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x73, 0x70, 0x22, 0xa3, 0x01, 0x0a, 0x0d, 0x44,
	...
	0x12, 0x3e, 0x0a, 0x0d, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x4f, 0x70,
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e,
	...
	0x03, 0x28, 0x09, 0x52, 0x0f, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x49, 0x44, 0x73, 0x22, 0x8a, 0x01, 0x0a, 0x0c, 0x53, 0x65, 0x71, 0x73, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x65, 0x73, 0x70, 0x12, 0x3e, 0x0a, 0x07, 0x6d, 0x61, 0x78, 0x53, 0x65, 0x71, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d,
	0x73, 0x67, 0x2e, 0x53, 0x65, 0x71, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x2e,
	...
	0x01, 0x22, 0xd0, 0x01, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x4d, 0x73, 0x67, 0x42, 0x79, 0x43, 0x6f,
	...
	0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x73, 0x12, 0x4c, 0x0a, 0x07, 0x6d, 0x61,
	0x78, 0x53, 0x65, 0x71, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x61, 0x65,
	0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x73, 0x67, 0x42, 0x79,
	...
	,
	...
	0x0a, 0x68, 0x61, 0x73, 0x52, 0x65, 0x61, 0x64, 0x53, 0x65, 0x71, 0x22, 0xbf, 0x01, 0x0a, 0x24,
	...
	0x52, 0x65, 0x73, 0x70, 0x12, 0x4d, 0x0a, 0x04, 0x73, 0x65, 0x71, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x39, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x47,
	...
	0x65, 0x71, 0x73, 0x1a, 0x48, 0x0a, 0x09, 0x53, 0x65, 0x71, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b,
	0x65, 0x79, 0x12, 0x25, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0f, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x53, 0x65,
	0x71, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa2, 0x01,
	...
	0x75, 0x70, 0x12, 0x3e, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x73,
	...
	0x6f, 0x6e, 0x22, 0x4d, 0x0a, 0x0a, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x74, 0x22, 0x83, 0x02, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x55,
	...
	0x74, 0x12, 0x49, 0x0a, 0x09, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67,
	...
	0x79, 0x52, 0x09, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x05,
	0x75, 0x73, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x61, 0x65,
	0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x55, 0x73,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8d, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x41,
	...
	0x28, 0x08, 0x52, 0x03, 0x61, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61, 0x65,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x51, 0x0a, 0x0b, 0x41, 0x63, 0x74, 0x69, 0x76,
	0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x2c, 0x0a, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18,
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x8a, 0x02, 0x0a, 0x12, 0x47,
	...
	0x03, 0x52, 0x0a, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x4a, 0x0a,
	0x09, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x2c, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e, 0x47, 0x65, 0x74,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x63, 0x76, 0x49, 0x44, 0x12, 0x20, 0x0a, 0x0b,
	...
	0x0b, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x3e, 0x0a, 0x0a,
	...
	0x52, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x65, 0x0a, 0x11,
	0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x12, 0x2e, 0x0a, 0x08, 0x63, 0x68, 0x61, 0x74, 0x4c, 0x6f, 0x67, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x2e,
	...
	0x70, 0x54, 0x79, 0x70, 0x65, 0x22, 0x65, 0x0a, 0x13, 0x62, 0x61, 0x74, 0x63, 0x68, 0x53, 0x65,
	...
	0x52, 0x0a, 0x72, 0x65, 0x63, 0x76, 0x49, 0x44, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x07,
	0x6d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2e, 0x4d, 0x73, 0x67, 0x44,
	...
	,
	...
	,
	...
	0x2f, 0x4d, 0x65, 0x69, 0x6b, 0x77, 0x65, 0x69, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
...
var file_msg_msg_proto_goTypes = []interface{}{
	(*MsgDataToMQ)(nil),                          // 0: aetim.msg.MsgDataToMQ
	(*MsgDataToDB)(nil),                          // 1: aetim.msg.MsgDataToDB
	(*PushMsgDataToMQ)(nil),                      // 2: aetim.msg.PushMsgDataToMQ
	(*MsgDataToMongoByMQ)(nil),                   // 3: aetim.msg.MsgDataToMongoByMQ
	(*GetMaxAndMinSeqReq)(nil),                   // 4: aetim.msg.GetMaxAndMinSeqReq
	(*GetMaxAndMinSeqResp)(nil),                  // 5: aetim.msg.GetMaxAndMinSeqResp
	(*SendMsgReq)(nil),                           // 6: aetim.msg.SendMsgReq
	(*SendMsgResp)(nil),                          // 7: aetim.msg.SendMsgResp
	(*SetSendMsgStatusReq)(nil),                  // 8: aetim.msg.SetSendMsgStatusReq
	(*SetSendMsgStatusResp)(nil),                 // 9: aetim.msg.SetSendMsgStatusResp
	(*GetSendMsgStatusReq)(nil),                  // 10: aetim.msg.GetSendMsgStatusReq
	(*GetSendMsgStatusResp)(nil),                 // 11: aetim.msg.GetSendMsgStatusResp
	(*MsgDataToModifyByMQ)(nil),                  // 12: aetim.msg.MsgDataToModifyByMQ
	(*DelMsgsReq)(nil),                           // 13: aetim.msg.DelMsgsReq
	(*DelMsgsResp)(nil),                          // 14: aetim.msg.DelMsgsResp
	(*RevokeMsgReq)(nil),                         // 15: aetim.msg.RevokeMsgReq
	(*RevokeMsgResp)(nil),                        // 16: aetim.msg.RevokeMsgResp
	(*MarkMsgsAsReadReq)(nil),                    // 17: aetim.msg.MarkMsgsAsReadReq
	(*MarkMsgsAsReadResp)(nil),                   // 18: aetim.msg.MarkMsgsAsReadResp
	(*MarkConversationAsReadReq)(nil),            // 19: aetim.msg.MarkConversationAsReadReq
	(*MarkConversationAsReadResp)(nil),           // 20: aetim.msg.MarkConversationAsReadResp
	(*SetConversationHasReadSeqReq)(nil),         // 21: aetim.msg.SetConversationHasReadSeqReq
	(*SetConversationHasReadSeqResp)(nil),        // 22: aetim.msg.SetConversationHasReadSeqResp
	(*DeleteSyncOpt)(nil),                        // 23: aetim.msg.DeleteSyncOpt
	(*ClearConversationsMsgReq)(nil),             // 24: aetim.msg.ClearConversationsMsgReq
	(*ClearConversationsMsgResp)(nil),            // 25: aetim.msg.ClearConversationsMsgResp
	(*UserClearAllMsgReq)(nil),                   // 26: aetim.msg.UserClearAllMsgReq
	(*UserClearAllMsgResp)(nil),                  // 27: aetim.msg.UserClearAllMsgResp
	(*DeleteMsgsReq)(nil),                        // 28: aetim.msg.DeleteMsgsReq
	(*DeleteMsgsResp)(nil),                       // 29: aetim.msg.DeleteMsgsResp
	(*DeleteMsgPhysicalReq)(nil),                 // 30: aetim.msg.DeleteMsgPhysicalReq
	(*DeleteMsgPhysicalResp)(nil),                // 31: aetim.msg.DeleteMsgPhysicalResp
	(*DeleteMsgPhysicalBySeqReq)(nil),            // 32: aetim.msg.DeleteMsgPhysicalBySeqReq
	(*DeleteMsgPhysicalBySeqResp)(nil),           // 33: aetim.msg.DeleteMsgPhysicalBySeqResp
	(*GetMaxSeqsReq)(nil),                        // 34: aetim.msg.GetMaxSeqsReq
	(*GetHasReadSeqsReq)(nil),                    // 35: aetim.msg.GetHasReadSeqsReq
	(*SeqsInfoResp)(nil),                         // 36: aetim.msg.SeqsInfoResp
	(*GetMsgByConversationIDsReq)(nil),           // 37: aetim.msg.GetMsgByConversationIDsReq
	(*GetMsgByConversationIDsResp)(nil),          // 38: aetim.msg.GetMsgByConversationIDsResp
	(*GetConversationMaxSeqReq)(nil),             // 39: aetim.msg.GetConversationMaxSeqReq
	(*GetConversationMaxSeqResp)(nil),            // 40: aetim.msg.GetConversationMaxSeqResp
	(*GetConversationsHasReadAndMaxSeqReq)(nil),  // 41: aetim.msg.GetConversationsHasReadAndMaxSeqReq
	(*Seqs)(nil),                                 // 42: aetim.msg.Seqs
	(*GetConversationsHasReadAndMaxSeqResp)(nil), // 43: aetim.msg.GetConversationsHasReadAndMaxSeqResp
	(*GetActiveUserReq)(nil),                     // 44: aetim.msg.GetActiveUserReq
	(*ActiveUser)(nil),                           // 45: aetim.msg.ActiveUser
	(*GetActiveUserResp)(nil),                    // 46: aetim.msg.GetActiveUserResp
	(*GetActiveGroupReq)(nil),                    // 47: aetim.msg.GetActiveGroupReq
	(*ActiveGroup)(nil),                          // 48: aetim.msg.ActiveGroup
	(*GetActiveGroupResp)(nil),                   // 49: aetim.msg.GetActiveGroupResp
	(*SearchMessageReq)(nil),                     // 50: aetim.msg.SearchMessageReq
	(*SearchMessageResp)(nil),                    // 51: aetim.msg.SearchMessageResp
	(*ChatLog)(nil),                              // 52: aetim.msg.ChatLog
	(*BatchSendMessageReq)(nil),                  // 53: aetim.msg.batchSendMessageReq
	(*BatchSendMessageResp)(nil),                 // 54: aetim.msg.batchSendMessageResp
	(*GetServerTimeReq)(nil),                     // 55: aetim.msg.GetServerTimeReq
	(*GetServerTimeResp)(nil),                    // 56: aetim.msg.GetServerTimeResp
	(*ClearMsgReq)(nil),                          // 57: aetim.msg.ClearMsgReq
	(*ClearMsgResp)(nil),                         // 58: aetim.msg.ClearMsgResp
	nil,                                          // 59: aetim.msg.SeqsInfoResp.MaxSeqsEntry
	nil,                                          // 60: aetim.msg.GetMsgByConversationIDsReq.MaxSeqsEntry
	nil,                                          // 61: aetim.msg.GetMsgByConversationIDsResp.MsgDatasEntry
	nil,                                          // 62: aetim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry
	nil,                                          // 63: aetim.msg.GetActiveUserResp.DateCountEntry
	nil,                                          // 64: aetim.msg.GetActiveGroupResp.DateCountEntry
	(*sdkws.MsgData)(nil),                        // 65: aetim.sdkws.MsgData
	(*sdkws.RequestPagination)(nil),              // 66: aetim.sdkws.RequestPagination
	(*sdkws.UserInfo)(nil),                       // 67: aetim.sdkws.UserInfo
	(*sdkws.GroupInfo)(nil),                      // 68: aetim.sdkws.GroupInfo
	(*sdkws.GetMaxSeqReq)(nil),                   // 69: aetim.sdkws.GetMaxSeqReq
	(*sdkws.PullMessageBySeqsReq)(nil),           // 70: aetim.sdkws.PullMessageBySeqsReq
	(*sdkws.GetMaxSeqResp)(nil),                  // 71: aetim.sdkws.GetMaxSeqResp
	(*sdkws.PullMessageBySeqsResp)(nil),          // 72: aetim.sdkws.PullMessageBySeqsResp
}
var file_msg_msg_proto_depIdxs = []int32{
	65, // 0: aetim.msg.MsgDataToMQ.msgData:type_name -> aetim.sdkws.MsgData
	65, // 1: aetim.msg.MsgDataToDB.msgData:type_name -> aetim.sdkws.MsgData
	65, // 2: aetim.msg.PushMsgDataToMQ.msgData:type_name -> aetim.sdkws.MsgData
	65, // 3: aetim.msg.MsgDataToMongoByMQ.msgData:type_name -> aetim.sdkws.MsgData
	65, // 4: aetim.msg.SendMsgReq.msgData:type_name -> aetim.sdkws.MsgData
	65, // 5: aetim.msg.MsgDataToModifyByMQ.messages:type_name -> aetim.sdkws.MsgData
	23, // 6: aetim.msg.ClearConversationsMsgReq.deleteSyncOpt:type_name -> aetim.msg.DeleteSyncOpt
	23, // 7: aetim.msg.UserClearAllMsgReq.deleteSyncOpt:type_name -> aetim.msg.DeleteSyncOpt
	23, // 8: aetim.msg.DeleteMsgsReq.deleteSyncOpt:type_name -> aetim.msg.DeleteSyncOpt
	59, // 9: aetim.msg.SeqsInfoResp.maxSeqs:type_name -> aetim.msg.SeqsInfoResp.MaxSeqsEntry
	60, // 10: aetim.msg.GetMsgByConversationIDsReq.maxSeqs:type_name -> aetim.msg.GetMsgByConversationIDsReq.MaxSeqsEntry
	61, // 11: aetim.msg.GetMsgByConversationIDsResp.msgDatas:type_name -> aetim.msg.GetMsgByConversationIDsResp.MsgDatasEntry
	62, // 12: aetim.msg.GetConversationsHasReadAndMaxSeqResp.seqs:type_name -> aetim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry
	66, // 13: aetim.msg.GetActiveUserReq.pagination:type_name -> aetim.sdkws.RequestPagination
	67, // 14: aetim.msg.ActiveUser.user:type_name -> aetim.sdkws.UserInfo
	63, // 15: aetim.msg.GetActiveUserResp.dateCount:type_name -> aetim.msg.GetActiveUserResp.DateCountEntry
	45, // 16: aetim.msg.GetActiveUserResp.users:type_name -> aetim.msg.ActiveUser
	66, // 17: aetim.msg.GetActiveGroupReq.pagination:type_name -> aetim.sdkws.RequestPagination
	68, // 18: aetim.msg.ActiveGroup.group:type_name -> aetim.sdkws.GroupInfo
	64, // 19: aetim.msg.GetActiveGroupResp.dateCount:type_name -> aetim.msg.GetActiveGroupResp.DateCountEntry
	48, // 20: aetim.msg.GetActiveGroupResp.groups:type_name -> aetim.msg.ActiveGroup
	66, // 21: aetim.msg.SearchMessageReq.pagination:type_name -> aetim.sdkws.RequestPagination
	52, // 22: aetim.msg.SearchMessageResp.chatLogs:type_name -> aetim.msg.ChatLog
	65, // 23: aetim.msg.batchSendMessageReq.msgData:type_name -> aetim.sdkws.MsgData
	65, // 24: aetim.msg.GetMsgByConversationIDsResp.MsgDatasEntry.value:type_name -> aetim.sdkws.MsgData
	42, // 25: aetim.msg.GetConversationsHasReadAndMaxSeqResp.SeqsEntry.value:type_name -> aetim.msg.Seqs
	69, // 26: aetim.msg.msg.GetMaxSeq:input_type -> aetim.sdkws.GetMaxSeqReq
	34, // 27: aetim.msg.msg.GetMaxSeqs:input_type -> aetim.msg.GetMaxSeqsReq
	35, // 28: aetim.msg.msg.GetHasReadSeqs:input_type -> aetim.msg.GetHasReadSeqsReq
	37, // 29: aetim.msg.msg.GetMsgByConversationIDs:input_type -> aetim.msg.GetMsgByConversationIDsReq
	39, // 30: aetim.msg.msg.GetConversationMaxSeq:input_type -> aetim.msg.GetConversationMaxSeqReq
	70, // 31: aetim.msg.msg.PullMessageBySeqs:input_type -> aetim.sdkws.PullMessageBySeqsReq
	50, // 32: aetim.msg.msg.SearchMessage:input_type -> aetim.msg.SearchMessageReq
	6,  // 33: aetim.msg.msg.SendMsg:input_type -> aetim.msg.SendMsgReq
	24, // 34: aetim.msg.msg.ClearConversationsMsg:input_type -> aetim.msg.ClearConversationsMsgReq
	26, // 35: aetim.msg.msg.UserClearAllMsg:input_type -> aetim.msg.UserClearAllMsgReq
	28, // 36: aetim.msg.msg.DeleteMsgs:input_type -> aetim.msg.DeleteMsgsReq
	32, // 37: aetim.msg.msg.DeleteMsgPhysicalBySeq:input_type -> aetim.msg.DeleteMsgPhysicalBySeqReq
	30, // 38: aetim.msg.msg.DeleteMsgPhysical:input_type -> aetim.msg.DeleteMsgPhysicalReq
	8,  // 39: aetim.msg.msg.SetSendMsgStatus:input_type -> aetim.msg.SetSendMsgStatusReq
	10, // 40: aetim.msg.msg.GetSendMsgStatus:input_type -> aetim.msg.GetSendMsgStatusReq
	15, // 41: aetim.msg.msg.RevokeMsg:input_type -> aetim.msg.RevokeMsgReq
	17, // 42: aetim.msg.msg.MarkMsgsAsRead:input_type -> aetim.msg.MarkMsgsAsReadReq
	19, // 43: aetim.msg.msg.MarkConversationAsRead:input_type -> aetim.msg.MarkConversationAsReadReq
	21, // 44: aetim.msg.msg.SetConversationHasReadSeq:input_type -> aetim.msg.SetConversationHasReadSeqReq
	41, // 45: aetim.msg.msg.GetConversationsHasReadAndMaxSeq:input_type -> aetim.msg.GetConversationsHasReadAndMaxSeqReq
	44, // 46: aetim.msg.msg.GetActiveUser:input_type -> aetim.msg.GetActiveUserReq
	47, // 47: aetim.msg.msg.GetActiveGroup:input_type -> aetim.msg.GetActiveGroupReq
	55, // 48: aetim.msg.msg.GetServerTime:input_type -> aetim.msg.GetServerTimeReq
	57, // 49: aetim.msg.msg.ClearMsg:input_type -> aetim.msg.ClearMsgReq
	71, // 50: aetim.msg.msg.GetMaxSeq:output_type -> aetim.sdkws.GetMaxSeqResp
	36, // 51: aetim.msg.msg.GetMaxSeqs:output_type -> aetim.msg.SeqsInfoResp
	36, // 52: aetim.msg.msg.GetHasReadSeqs:output_type -> aetim.msg.SeqsInfoResp
	38, // 53: aetim.msg.msg.GetMsgByConversationIDs:output_type -> aetim.msg.GetMsgByConversationIDsResp
	40, // 54: aetim.msg.msg.GetConversationMaxSeq:output_type -> aetim.msg.GetConversationMaxSeqResp
	72, // 55: aetim.msg.msg.PullMessageBySeqs:output_type -> aetim.sdkws.PullMessageBySeqsResp
	51, // 56: aetim.msg.msg.SearchMessage:output_type -> aetim.msg.SearchMessageResp
	7,  // 57: aetim.msg.msg.SendMsg:output_type -> aetim.msg.SendMsgResp
	25, // 58: aetim.msg.msg.ClearConversationsMsg:output_type -> aetim.msg.ClearConversationsMsgResp
	27, // 59: aetim.msg.msg.UserClearAllMsg:output_type -> aetim.msg.UserClearAllMsgResp
	29, // 60: aetim.msg.msg.DeleteMsgs:output_type -> aetim.msg.DeleteMsgsResp
	33, // 61: aetim.msg.msg.DeleteMsgPhysicalBySeq:output_type -> aetim.msg.DeleteMsgPhysicalBySeqResp
	31, // 62: aetim.msg.msg.DeleteMsgPhysical:output_type -> aetim.msg.DeleteMsgPhysicalResp
	9,  // 63: aetim.msg.msg.SetSendMsgStatus:output_type -> aetim.msg.SetSendMsgStatusResp
	11, // 64: aetim.msg.msg.GetSendMsgStatus:output_type -> aetim.msg.GetSendMsgStatusResp
	16, // 65: aetim.msg.msg.RevokeMsg:output_type -> aetim.msg.RevokeMsgResp
	18, // 66: aetim.msg.msg.MarkMsgsAsRead:output_type -> aetim.msg.MarkMsgsAsReadResp
	20, // 67: aetim.msg.msg.MarkConversationAsRead:output_type -> aetim.msg.MarkConversationAsReadResp
	22, // 68: aetim.msg.msg.SetConversationHasReadSeq:output_type -> aetim.msg.SetConversationHasReadSeqResp
	43, // 69: aetim.msg.msg.GetConversationsHasReadAndMaxSeq:output_type -> aetim.msg.GetConversationsHasReadAndMaxSeqResp
	46, // 70: aetim.msg.msg.GetActiveUser:output_type -> aetim.msg.GetActiveUserResp
	49, // 71: aetim.msg.msg.GetActiveGroup:output_type -> aetim.msg.GetActiveGroupResp
	56, // 72: aetim.msg.msg.GetServerTime:output_type -> aetim.msg.GetServerTimeResp
	58, // 73: aetim.msg.msg.ClearMsg:output_type -> aetim.msg.ClearMsgResp
...
func (c *msgClient) GetMaxSeq(ctx context.Context, in *sdkws.GetMaxSeqReq, opts ...grpc.CallOption) (*sdkws.GetMaxSeqResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetMaxSeq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetMaxSeqs(ctx context.Context, in *GetMaxSeqsReq, opts ...grpc.CallOption) (*SeqsInfoResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetMaxSeqs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetHasReadSeqs(ctx context.Context, in *GetHasReadSeqsReq, opts ...grpc.CallOption) (*SeqsInfoResp, error) {
	out := new(SeqsInfoResp)
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetHasReadSeqs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetMsgByConversationIDs(ctx context.Context, in *GetMsgByConversationIDsReq, opts ...grpc.CallOption) (*GetMsgByConversationIDsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetMsgByConversationIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetConversationMaxSeq(ctx context.Context, in *GetConversationMaxSeqReq, opts ...grpc.CallOption) (*GetConversationMaxSeqResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetConversationMaxSeq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) PullMessageBySeqs(ctx context.Context, in *sdkws.PullMessageBySeqsReq, opts ...grpc.CallOption) (*sdkws.PullMessageBySeqsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/PullMessageBySeqs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SearchMessage(ctx context.Context, in *SearchMessageReq, opts ...grpc.CallOption) (*SearchMessageResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/SearchMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SendMsg(ctx context.Context, in *SendMsgReq, opts ...grpc.CallOption) (*SendMsgResp, error) {
	out := new(SendMsgResp)
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/SendMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClearConversationsMsg(ctx context.Context, in *ClearConversationsMsgReq, opts ...grpc.CallOption) (*ClearConversationsMsgResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/ClearConversationsMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UserClearAllMsg(ctx context.Context, in *UserClearAllMsgReq, opts ...grpc.CallOption) (*UserClearAllMsgResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/UserClearAllMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteMsgs(ctx context.Context, in *DeleteMsgsReq, opts ...grpc.CallOption) (*DeleteMsgsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/DeleteMsgs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteMsgPhysicalBySeq(ctx context.Context, in *DeleteMsgPhysicalBySeqReq, opts ...grpc.CallOption) (*DeleteMsgPhysicalBySeqResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/DeleteMsgPhysicalBySeq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteMsgPhysical(ctx context.Context, in *DeleteMsgPhysicalReq, opts ...grpc.CallOption) (*DeleteMsgPhysicalResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/DeleteMsgPhysical", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetSendMsgStatus(ctx context.Context, in *SetSendMsgStatusReq, opts ...grpc.CallOption) (*SetSendMsgStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/SetSendMsgStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetSendMsgStatus(ctx context.Context, in *GetSendMsgStatusReq, opts ...grpc.CallOption) (*GetSendMsgStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetSendMsgStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RevokeMsg(ctx context.Context, in *RevokeMsgReq, opts ...grpc.CallOption) (*RevokeMsgResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/RevokeMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) MarkMsgsAsRead(ctx context.Context, in *MarkMsgsAsReadReq, opts ...grpc.CallOption) (*MarkMsgsAsReadResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/MarkMsgsAsRead", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) MarkConversationAsRead(ctx context.Context, in *MarkConversationAsReadReq, opts ...grpc.CallOption) (*MarkConversationAsReadResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/MarkConversationAsRead", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetConversationHasReadSeq(ctx context.Context, in *SetConversationHasReadSeqReq, opts ...grpc.CallOption) (*SetConversationHasReadSeqResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/SetConversationHasReadSeq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetConversationsHasReadAndMaxSeq(ctx context.Context, in *GetConversationsHasReadAndMaxSeqReq, opts ...grpc.CallOption) (*GetConversationsHasReadAndMaxSeqResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetConversationsHasReadAndMaxSeq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetActiveUser(ctx context.Context, in *GetActiveUserReq, opts ...grpc.CallOption) (*GetActiveUserResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetActiveUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetActiveGroup(ctx context.Context, in *GetActiveGroupReq, opts ...grpc.CallOption) (*GetActiveGroupResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetActiveGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GetServerTime(ctx context.Context, in *GetServerTimeReq, opts ...grpc.CallOption) (*GetServerTimeResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/GetServerTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClearMsg(ctx context.Context, in *ClearMsgReq, opts ...grpc.CallOption) (*ClearMsgResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msg.msg/ClearMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_GetMaxSeq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetMaxSeq",
	}
...
func _Msg_GetMaxSeqs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetMaxSeqs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetHasReadSeqs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetHasReadSeqs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetMsgByConversationIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetMsgByConversationIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetConversationMaxSeq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetConversationMaxSeq",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_PullMessageBySeqs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/PullMessageBySeqs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SearchMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/SearchMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SendMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/SendMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClearConversationsMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/ClearConversationsMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UserClearAllMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/UserClearAllMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteMsgs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/DeleteMsgs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteMsgPhysicalBySeq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/DeleteMsgPhysicalBySeq",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteMsgPhysical_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/DeleteMsgPhysical",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetSendMsgStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/SetSendMsgStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetSendMsgStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetSendMsgStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RevokeMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/RevokeMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_MarkMsgsAsRead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/MarkMsgsAsRead",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_MarkConversationAsRead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/MarkConversationAsRead",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetConversationHasReadSeq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/SetConversationHasReadSeq",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetConversationsHasReadAndMaxSeq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetConversationsHasReadAndMaxSeq",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetActiveUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetActiveUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetActiveGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetActiveGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GetServerTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/GetServerTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClearMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msg.msg/ClearMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

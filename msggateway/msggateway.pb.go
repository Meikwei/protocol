...
type OnlinePushMsgReq struct {
	...
	MsgData      *sdkws.MsgData `protobuf:"bytes,1,opt,name=msgData,proto3" json:"msgData"`           // 消息内容
	PushToUserID string         `protobuf:"bytes,2,opt,name=pushToUserID,proto3" json:"pushToUserID"` // 推送目标用户ID
}
...
type OnlinePushMsgResp struct {
	...
	Resp []*SingleMsgToUserPlatform `protobuf:"bytes,1,rep,name=resp,proto3" json:"resp"` // 响应结果集合
}
...
type SingleMsgToUserResults struct {
	...
	Resp       []*SingleMsgToUserPlatform `protobuf:"bytes,2,rep,name=resp,proto3" json:"resp"`              // 各平台推送结果
	OnlinePush bool                       `protobuf:"varint,3,opt,name=onlinePush,proto3" json:"onlinePush"` // 是否成功推送在线消息
}
...
type OnlineBatchPushOneMsgReq struct {
	...
	MsgData       *sdkws.MsgData `protobuf:"bytes,1,opt,name=msgData,proto3" json:"msgData"`             // 消息内容
	PushToUserIDs []string       `protobuf:"bytes,2,rep,name=pushToUserIDs,proto3" json:"pushToUserIDs"` // 推送目标用户ID列表
}
...
type OnlineBatchPushOneMsgResp struct {
	...
	SinglePushResult []*SingleMsgToUserResults `protobuf:"bytes,1,rep,name=singlePushResult,proto3" json:"singlePushResult"` // 单个用户推送结果的集合
}
...
type SingleMsgToUserPlatform struct {
	...
	ResultCode     int64  `protobuf:"varint,1,opt,name=ResultCode,proto3" json:"ResultCode"`         // 结果码
	RecvID         string `protobuf:"bytes,2,opt,name=RecvID,proto3" json:"RecvID"`                  // 接收消息的用户ID
	RecvPlatFormID int32  `protobuf:"varint,3,opt,name=RecvPlatFormID,proto3" json:"RecvPlatFormID"` // 接收消息的用户平台ID
}
...
type GetUsersOnlineStatusReq struct {
	...
	UserIDs []string `protobuf:"bytes,1,rep,name=userIDs,proto3" json:"userIDs"` // 需要查询在线状态的用户ID列表
}
...
type GetUsersOnlineStatusResp struct {
	...
	SuccessResult []*GetUsersOnlineStatusResp_SuccessResult `protobuf:"bytes,1,rep,name=successResult,proto3" json:"successResult"` // 查询成功的用户在线状态结果
	FailedResult  []*GetUsersOnlineStatusResp_FailedDetail  `protobuf:"bytes,2,rep,name=failedResult,proto3" json:"failedResult"`   // 查询失败的用户ID列表
}
...
type SingleDetail struct {
	...
	UserID              string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID"`                           // 用户ID
	Status              string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status"`                           // 在线状态
	SinglePlatformToken []*SinglePlatformToken `protobuf:"bytes,3,rep,name=singlePlatformToken,proto3" json:"singlePlatformToken"` // 各平台登录token信息
}
...
type SinglePlatformToken struct {
	...
	Platform string   `protobuf:"bytes,1,opt,name=platform,proto3" json:"platform"` // 平台标识
	Total    int32    `protobuf:"varint,2,opt,name=total,proto3" json:"total"`      // 登录token总数
	Token    []string `protobuf:"bytes,3,rep,name=token,proto3" json:"token"`       // 登录token列表
}
...
type KickUserOfflineReq struct {
	...
	KickUserIDList []string `protobuf:"bytes,2,rep,name=kickUserIDList,proto3" json:"kickUserIDList"` // 需要踢下的用户ID列表
}
...
type MultiTerminalLoginCheckReq struct {
	...
	UserID     string `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID"`          // 用户ID
	PlatformID int32  `protobuf:"varint,2,opt,name=platformID,proto3" json:"platformID"` // 平台ID
	Token      string `protobuf:"bytes,3,opt,name=token,proto3" json:"token"`            // 用户token
}
...
type GetUsersOnlineStatusResp_SuccessDetail struct {
	...
	Status       string `protobuf:"bytes,2,opt,name=status,proto3" json:"status"`              // 在线状态
	ConnID       string `protobuf:"bytes,3,opt,name=connID,proto3" json:"connID"`              // 连接ID
	IsBackground bool   `protobuf:"varint,4,opt,name=isBackground,proto3" json:"isBackground"` // 是否是后台
	Token        string `protobuf:"bytes,5,opt,name=token,proto3" json:"token"`                // 用户token
}
...
type GetUsersOnlineStatusResp_SuccessResult struct {
	...
	UserID               string                                    `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID"`                             // 用户ID
	Status               string                                    `protobuf:"bytes,2,opt,name=status,proto3" json:"status"`                             // 用户整体在线状态
	DetailPlatformStatus []*GetUsersOnlineStatusResp_SuccessDetail `protobuf:"bytes,3,rep,name=detailPlatformStatus,proto3" json:"detailPlatformStatus"` // 各平台在线状态详情
}
...
var file_msggateway_msggateway_proto_rawDesc = []byte{
	...
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x61,
	0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x1a,
	0x11, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2f, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x22, 0x66, 0x0a, 0x10, 0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x50, 0x75, 0x73, 0x68,
	0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x12, 0x2e, 0x0a, 0x07, 0x6d, 0x73, 0x67, 0x44, 0x61, 0x74,
	0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e,
	...
	,
	...
	0x22, 0x70, 0x0a, 0x18, 0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x50,
	0x75, 0x73, 0x68, 0x4f, 0x6e, 0x65, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x71, 0x12, 0x2e, 0x0a, 0x07,
	0x6d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x73, 0x64, 0x6b, 0x77, 0x73, 0x2e, 0x4d, 0x73, 0x67, 0x44,
	0x61, 0x74, 0x61, 0x52, 0x07, 0x6d, 0x73, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x24, 0x0a, 0x0d,
	...
	,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x2e, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73,
	0x75, 0x6c, 0x74, 0x52, 0x0d, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x12, 0x5b, 0x0a, 0x0c, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x52, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d,
	...
	0x95, 0x01, 0x0a, 0x0d, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x44, 0x65, 0x74, 0x61, 0x69,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x6e, 0x49, 0x44, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x6e, 0x49, 0x44, 0x12, 0x22, 0x0a,
	0x0c, 0x69, 0x73, 0x42, 0x61, 0x63, 0x6b, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x04, 0x20,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x26, 0x0a, 0x0c, 0x46, 0x61, 0x69, 0x6c, 0x65,
	0x64, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49,
	0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x1a,
	0xad, 0x01, 0x0a, 0x0d, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x75, 0x6c,
	...
	0x73, 0x12, 0x6c, 0x0a, 0x14, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x50, 0x6c, 0x61, 0x74, 0x66,
	0x6f, 0x72, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x38, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x67, 0x61, 0x74, 0x65, 0x77,
	...
	0x97, 0x01, 0x0a, 0x0c, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c,
	...
	0x12, 0x57, 0x0a, 0x13, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x50, 0x6c, 0x61, 0x74, 0x66, 0x6f,
	0x72, 0x6d, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e,
	0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73, 0x67, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x2e, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x50, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x13, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x50, 0x6c, 0x61, 0x74,
	0x66, 0x6f, 0x72, 0x6d, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5d, 0x0a, 0x13, 0x53, 0x69, 0x6e,
	...
	,
	...
	,
	...
	0x12, 0x70, 0x0a, 0x15, 0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x50,
	0x75, 0x73, 0x68, 0x4f, 0x6e, 0x65, 0x4d, 0x73, 0x67, 0x12, 0x2a, 0x2e, 0x61, 0x65, 0x74, 0x69,
	...
	0x73, 0x67, 0x52, 0x65, 0x71, 0x1a, 0x2b, 0x2e, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x6d, 0x73,
	...
	,
...
var file_msggateway_msggateway_proto_goTypes = []interface{}{
	(*OnlinePushMsgReq)(nil),                       // 0: aetim.msggateway.OnlinePushMsgReq
	(*OnlinePushMsgResp)(nil),                      // 1: aetim.msggateway.OnlinePushMsgResp
	(*SingleMsgToUserResults)(nil),                 // 2: aetim.msggateway.SingleMsgToUserResults
	(*OnlineBatchPushOneMsgReq)(nil),               // 3: aetim.msggateway.OnlineBatchPushOneMsgReq
	(*OnlineBatchPushOneMsgResp)(nil),              // 4: aetim.msggateway.OnlineBatchPushOneMsgResp
	(*SingleMsgToUserPlatform)(nil),                // 5: aetim.msggateway.SingleMsgToUserPlatform
	(*GetUsersOnlineStatusReq)(nil),                // 6: aetim.msggateway.GetUsersOnlineStatusReq
	(*GetUsersOnlineStatusResp)(nil),               // 7: aetim.msggateway.GetUsersOnlineStatusResp
	(*SingleDetail)(nil),                           // 8: aetim.msggateway.SingleDetail
	(*SinglePlatformToken)(nil),                    // 9: aetim.msggateway.SinglePlatformToken
	(*KickUserOfflineReq)(nil),                     // 10: aetim.msggateway.KickUserOfflineReq
	(*KickUserOfflineResp)(nil),                    // 11: aetim.msggateway.KickUserOfflineResp
	(*MultiTerminalLoginCheckReq)(nil),             // 12: aetim.msggateway.MultiTerminalLoginCheckReq
	(*MultiTerminalLoginCheckResp)(nil),            // 13: aetim.msggateway.MultiTerminalLoginCheckResp
	(*GetUsersOnlineStatusResp_SuccessDetail)(nil), // 14: aetim.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	(*GetUsersOnlineStatusResp_FailedDetail)(nil),  // 15: aetim.msggateway.GetUsersOnlineStatusResp.FailedDetail
	(*GetUsersOnlineStatusResp_SuccessResult)(nil), // 16: aetim.msggateway.GetUsersOnlineStatusResp.SuccessResult
	(*sdkws.MsgData)(nil),                          // 17: aetim.sdkws.MsgData
}
var file_msggateway_msggateway_proto_depIdxs = []int32{
	17, // 0: aetim.msggateway.OnlinePushMsgReq.msgData:type_name -> aetim.sdkws.MsgData
	5,  // 1: aetim.msggateway.OnlinePushMsgResp.resp:type_name -> aetim.msggateway.SingleMsgToUserPlatform
	5,  // 2: aetim.msggateway.SingleMsgToUserResults.resp:type_name -> aetim.msggateway.SingleMsgToUserPlatform
	17, // 3: aetim.msggateway.OnlineBatchPushOneMsgReq.msgData:type_name -> aetim.sdkws.MsgData
	2,  // 4: aetim.msggateway.OnlineBatchPushOneMsgResp.singlePushResult:type_name -> aetim.msggateway.SingleMsgToUserResults
	16, // 5: aetim.msggateway.GetUsersOnlineStatusResp.successResult:type_name -> aetim.msggateway.GetUsersOnlineStatusResp.SuccessResult
	15, // 6: aetim.msggateway.GetUsersOnlineStatusResp.failedResult:type_name -> aetim.msggateway.GetUsersOnlineStatusResp.FailedDetail
	9,  // 7: aetim.msggateway.SingleDetail.singlePlatformToken:type_name -> aetim.msggateway.SinglePlatformToken
	14, // 8: aetim.msggateway.GetUsersOnlineStatusResp.SuccessResult.detailPlatformStatus:type_name -> aetim.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	0,  // 9: aetim.msggateway.msgGateway.OnlinePushMsg:input_type -> aetim.msggateway.OnlinePushMsgReq
	6,  // 10: aetim.msggateway.msgGateway.GetUsersOnlineStatus:input_type -> aetim.msggateway.GetUsersOnlineStatusReq
	3,  // 11: aetim.msggateway.msgGateway.OnlineBatchPushOneMsg:input_type -> aetim.msggateway.OnlineBatchPushOneMsgReq
	3,  // 12: aetim.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:input_type -> aetim.msggateway.OnlineBatchPushOneMsgReq
	10, // 13: aetim.msggateway.msgGateway.KickUserOffline:input_type -> aetim.msggateway.KickUserOfflineReq
	12, // 14: aetim.msggateway.msgGateway.MultiTerminalLoginCheck:input_type -> aetim.msggateway.MultiTerminalLoginCheckReq
	1,  // 15: aetim.msggateway.msgGateway.OnlinePushMsg:output_type -> aetim.msggateway.OnlinePushMsgResp
	7,  // 16: aetim.msggateway.msgGateway.GetUsersOnlineStatus:output_type -> aetim.msggateway.GetUsersOnlineStatusResp
	4,  // 17: aetim.msggateway.msgGateway.OnlineBatchPushOneMsg:output_type -> aetim.msggateway.OnlineBatchPushOneMsgResp
	4,  // 18: aetim.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:output_type -> aetim.msggateway.OnlineBatchPushOneMsgResp
	11, // 19: aetim.msggateway.msgGateway.KickUserOffline:output_type -> aetim.msggateway.KickUserOfflineResp
	13, // 20: aetim.msggateway.msgGateway.MultiTerminalLoginCheck:output_type -> aetim.msggateway.MultiTerminalLoginCheckResp
...
func (c *msgGatewayClient) OnlinePushMsg(ctx context.Context, in *OnlinePushMsgReq, opts ...grpc.CallOption) (*OnlinePushMsgResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msggateway.msgGateway/OnlinePushMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgGatewayClient) GetUsersOnlineStatus(ctx context.Context, in *GetUsersOnlineStatusReq, opts ...grpc.CallOption) (*GetUsersOnlineStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msggateway.msgGateway/GetUsersOnlineStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgGatewayClient) OnlineBatchPushOneMsg(ctx context.Context, in *OnlineBatchPushOneMsgReq, opts ...grpc.CallOption) (*OnlineBatchPushOneMsgResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msggateway.msgGateway/OnlineBatchPushOneMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgGatewayClient) SuperGroupOnlineBatchPushOneMsg(ctx context.Context, in *OnlineBatchPushOneMsgReq, opts ...grpc.CallOption) (*OnlineBatchPushOneMsgResp, error) {
	out := new(OnlineBatchPushOneMsgResp)
	err := c.cc.Invoke(ctx, "/aetim.msggateway.msgGateway/SuperGroupOnlineBatchPushOneMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgGatewayClient) KickUserOffline(ctx context.Context, in *KickUserOfflineReq, opts ...grpc.CallOption) (*KickUserOfflineResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msggateway.msgGateway/KickUserOffline", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgGatewayClient) MultiTerminalLoginCheck(ctx context.Context, in *MultiTerminalLoginCheckReq, opts ...grpc.CallOption) (*MultiTerminalLoginCheckResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.msggateway.msgGateway/MultiTerminalLoginCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgGateway_OnlinePushMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msggateway.msgGateway/OnlinePushMsg",
	}
...
func _MsgGateway_GetUsersOnlineStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msggateway.msgGateway/GetUsersOnlineStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgGateway_OnlineBatchPushOneMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msggateway.msgGateway/OnlineBatchPushOneMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgGateway_SuperGroupOnlineBatchPushOneMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msggateway.msgGateway/SuperGroupOnlineBatchPushOneMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgGateway_KickUserOffline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msggateway.msgGateway/KickUserOffline",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MsgGateway_MultiTerminalLoginCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.msggateway.msgGateway/MultiTerminalLoginCheck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _MsgGateway_serviceDesc = grpc.ServiceDesc{
	ServiceName: "aetim.msggateway.msgGateway",

...
// 以下导入是为了抑制错误，如果它们没有被其他方式使用。
var _ context.Context
var _ grpc.ClientConnInterface

// 这是一个编译时的断言，确保这个生成的文件与正在编译的grpc包兼容。
const _ = grpc.SupportPackageIsVersion6

// ConversationClient 是与Conversation服务进行交互的客户端API。
//
// 关于ctx的使用以及如何结束流式RPC调用的语义，请参考https://godoc.org/google.golang.org/grpc#ClientConn.NewStream。
// ConversationClient 定义了与对话相关的客户端接口
type ConversationClient interface {
    // GetConversation 通过请求获取特定对话信息
    // ctx context.Context：上下文信息，用于控制请求的生命周期。
    // in *GetConversationReq：请求参数，包含需要获取的对话的相关信息。
    // opts ...grpc.CallOption：gRPC调用选项，可用于配置调用的额外选项。
    // 返回值 *GetConversationResp：响应数据，包含获取到的对话信息。
    // 返回值 error：错误信息，如果调用失败则返回错误信息。
	GetConversation(ctx context.Context, in *GetConversationReq, opts ...grpc.CallOption) (*GetConversationResp, error)

    // GetSortedConversationList 获取排序后的对话列表
    // ctx context.Context：上下文信息。
    // in *GetSortedConversationListReq：请求参数，包含获取排序对话列表的条件。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetSortedConversationListResp：响应数据，包含排序后的对话列表。
    // 返回值 error：错误信息。
    ...
    // ctx context.Context：上下文信息。
    // in *GetAllConversationsReq：请求参数，无特殊请求参数。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetAllConversationsResp：响应数据，包含所有对话的信息。
    // 返回值 error：错误信息。
	GetAllConversations(ctx context.Context, in *GetAllConversationsReq, opts ...grpc.CallOption) (*GetAllConversationsResp, error)

    // GetConversations 根据请求条件获取对话信息
    // ctx context.Context：上下文信息。
    // in *GetConversationsReq：请求参数，包含获取对话的条件。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetConversationsResp：响应数据，包含符合条件的对话信息列表。
    // 返回值 error：错误信息。
	GetConversations(ctx context.Context, in *GetConversationsReq, opts ...grpc.CallOption) (*GetConversationsResp, error)

    // SetConversation 设置对话信息
    // ctx context.Context：上下文信息。
    // in *SetConversationReq：请求参数，包含需要设置的对话信息。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *SetConversationResp：响应数据，通常用于确认设置操作是否成功。
    // 返回值 error：错误信息。
	SetConversation(ctx context.Context, in *SetConversationReq, opts ...grpc.CallOption) (*SetConversationResp, error)

    // GetRecvMsgNotNotifyUserIDs 获取不通知消息的用户ID列表
    // ctx context.Context：上下文信息。
    // in *GetRecvMsgNotNotifyUserIDsReq：请求参数，无特殊请求参数。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetRecvMsgNotNotifyUserIDsResp：响应数据，包含不通知消息的用户ID列表。
    // 返回值 error：错误信息。
    ...
    // CreateSingleChatConversations 创建单聊对话
    // ctx context.Context：上下文信息。
    // in *CreateSingleChatConversationsReq：请求参数，包含创建单聊对话所需的用户信息等。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *CreateSingleChatConversationsResp：响应数据，包含创建的单聊对话信息。
    // 返回值 error：错误信息。
    ...
    // CreateGroupChatConversations 创建群聊对话
    // ctx context.Context：上下文信息。
    // in *CreateGroupChatConversationsReq：请求参数，包含创建群聊对话所需的群组信息等。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *CreateGroupChatConversationsResp：响应数据，包含创建的群聊对话信息。
    // 返回值 error：错误信息。
    ...
    // ctx context.Context：上下文信息。
    // in *SetConversationMaxSeqReq：请求参数，包含需要设置最大序列号的对话信息。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *SetConversationMaxSeqResp：响应数据，通常用于确认设置操作是否成功。
    // 返回值 error：错误信息。
    ...
    // GetConversationIDs 获取对话ID列表
    // ctx context.Context：上下文信息。
    // in *GetConversationIDsReq：请求参数，无特殊请求参数。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetConversationIDsResp：响应数据，包含对话的ID列表。
    // 返回值 error：错误信息。
	GetConversationIDs(ctx context.Context, in *GetConversationIDsReq, opts ...grpc.CallOption) (*GetConversationIDsResp, error)

    // SetConversations 设置多个对话信息
    // ctx context.Context：上下文信息。
    // in *SetConversationsReq：请求参数，包含需要设置的多个对话信息。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *SetConversationsResp：响应数据，通常用于确认设置操作是否成功。
    // 返回值 error：错误信息。
	SetConversations(ctx context.Context, in *SetConversationsReq, opts ...grpc.CallOption) (*SetConversationsResp, error)

    // GetUserConversationIDsHash 获取用户对话ID的哈希值
    // ctx context.Context：上下文信息。
    // in *GetUserConversationIDsHashReq：请求参数，无特殊请求参数。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetUserConversationIDsHashResp：响应数据，包含用户对话ID的哈希值。
    // 返回值 error：错误信息。
    ...
    // GetConversationsByConversationID 根据对话ID获取对话信息
    // ctx context.Context：上下文信息。
    // in *GetConversationsByConversationIDReq：请求参数，包含需要获取的对话的ID。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetConversationsByConversationIDResp：响应数据，包含根据对话ID获取到的对话信息。
    // 返回值 error：错误信息。
    ...
    // GetConversationOfflinePushUserIDs 获取对话离线推送的用户ID列表
    // ctx context.Context：上下文信息。
    // in *GetConversationOfflinePushUserIDsReq：请求参数，包含需要获取离线推送用户ID的对话信息。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetConversationOfflinePushUserIDsResp：响应数据，包含对话离线推送的用户ID列表。
    // 返回值 error：错误信息。
    ...
    // ctx context.Context：上下文信息。
    // in *GetConversationNotReceiveMessageUserIDsReq：请求参数，包含需要获取未接收消息用户ID的对话信息。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *GetConversationNotReceiveMessageUserIDsResp：响应数据，包含对话中未接收消息的用户ID列表。
    // 返回值 error：错误信息。
    ...
    // ctx context.Context：上下文信息。
    // in *UpdateConversationReq：请求参数，包含需要更新的对话信息。
    // opts ...grpc.CallOption：gRPC调用选项。
    // 返回值 *UpdateConversationResp：响应数据，通常用于确认更新操作是否成功。
    // 返回值 error：错误信息。
...
func (c *conversationClient) GetConversation(ctx context.Context, in *GetConversationReq, opts ...grpc.CallOption) (*GetConversationResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetConversation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetSortedConversationList(ctx context.Context, in *GetSortedConversationListReq, opts ...grpc.CallOption) (*GetSortedConversationListResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetSortedConversationList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetAllConversations(ctx context.Context, in *GetAllConversationsReq, opts ...grpc.CallOption) (*GetAllConversationsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetAllConversations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetConversations(ctx context.Context, in *GetConversationsReq, opts ...grpc.CallOption) (*GetConversationsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetConversations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) SetConversation(ctx context.Context, in *SetConversationReq, opts ...grpc.CallOption) (*SetConversationResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/SetConversation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetRecvMsgNotNotifyUserIDs(ctx context.Context, in *GetRecvMsgNotNotifyUserIDsReq, opts ...grpc.CallOption) (*GetRecvMsgNotNotifyUserIDsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetRecvMsgNotNotifyUserIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) CreateSingleChatConversations(ctx context.Context, in *CreateSingleChatConversationsReq, opts ...grpc.CallOption) (*CreateSingleChatConversationsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/CreateSingleChatConversations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) CreateGroupChatConversations(ctx context.Context, in *CreateGroupChatConversationsReq, opts ...grpc.CallOption) (*CreateGroupChatConversationsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/CreateGroupChatConversations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) SetConversationMaxSeq(ctx context.Context, in *SetConversationMaxSeqReq, opts ...grpc.CallOption) (*SetConversationMaxSeqResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/SetConversationMaxSeq", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetConversationIDs(ctx context.Context, in *GetConversationIDsReq, opts ...grpc.CallOption) (*GetConversationIDsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetConversationIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) SetConversations(ctx context.Context, in *SetConversationsReq, opts ...grpc.CallOption) (*SetConversationsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/SetConversations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetUserConversationIDsHash(ctx context.Context, in *GetUserConversationIDsHashReq, opts ...grpc.CallOption) (*GetUserConversationIDsHashResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetUserConversationIDsHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetConversationsByConversationID(ctx context.Context, in *GetConversationsByConversationIDReq, opts ...grpc.CallOption) (*GetConversationsByConversationIDResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetConversationsByConversationID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetConversationOfflinePushUserIDs(ctx context.Context, in *GetConversationOfflinePushUserIDsReq, opts ...grpc.CallOption) (*GetConversationOfflinePushUserIDsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetConversationOfflinePushUserIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) GetConversationNotReceiveMessageUserIDs(ctx context.Context, in *GetConversationNotReceiveMessageUserIDsReq, opts ...grpc.CallOption) (*GetConversationNotReceiveMessageUserIDsResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/GetConversationNotReceiveMessageUserIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversationClient) UpdateConversation(ctx context.Context, in *UpdateConversationReq, opts ...grpc.CallOption) (*UpdateConversationResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.conversation.conversation/UpdateConversation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Conversation_GetConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetConversation",
	}
...
func _Conversation_GetSortedConversationList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetSortedConversationList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetAllConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetAllConversations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetConversations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_SetConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/SetConversation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetRecvMsgNotNotifyUserIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetRecvMsgNotNotifyUserIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_CreateSingleChatConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/CreateSingleChatConversations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_CreateGroupChatConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/CreateGroupChatConversations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_SetConversationMaxSeq_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/SetConversationMaxSeq",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetConversationIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetConversationIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_SetConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/SetConversations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetUserConversationIDsHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetUserConversationIDsHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetConversationsByConversationID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetConversationsByConversationID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetConversationOfflinePushUserIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetConversationOfflinePushUserIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_GetConversationNotReceiveMessageUserIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/GetConversationNotReceiveMessageUserIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Conversation_UpdateConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.conversation.conversation/UpdateConversation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Conversation_serviceDesc = grpc.ServiceDesc{
	ServiceName: "aetim.conversation.conversation",

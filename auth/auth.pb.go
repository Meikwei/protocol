...
type UserTokenReq struct {
	...
	Secret     string `protobuf:"bytes,1,opt,name=secret,proto3" json:"secret"`          // 秘钥
...
type UserTokenResp struct {
	...
	Token             string `protobuf:"bytes,2,opt,name=token,proto3" json:"token"`                          // 生成的用户令牌
	ExpireTimeSeconds int64  `protobuf:"varint,3,opt,name=expireTimeSeconds,proto3" json:"expireTimeSeconds"` // 令牌过期时间（秒）
}
...
type ParseTokenReq struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token"` // 待解析的令牌
}
...
type ParseTokenResp struct {
	...
	UserID            string `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID"`                        // 解析出的用户ID
	PlatformID        int32  `protobuf:"varint,2,opt,name=platformID,proto3" json:"platformID"`               // 解析出的平台ID
	ExpireTimeSeconds int64  `protobuf:"varint,4,opt,name=expireTimeSeconds,proto3" json:"expireTimeSeconds"` // 令牌过期时间（秒）
}
...
type GetUserTokenResp struct {
	...
	Token             string `protobuf:"bytes,1,opt,name=token,proto3" json:"token"`                          // 获取到的用户令牌
	ExpireTimeSeconds int64  `protobuf:"varint,2,opt,name=expireTimeSeconds,proto3" json:"expireTimeSeconds"` // 令牌过期时间（秒）
}
...
type InvalidateTokenReq struct {
	...
	PreservedToken string `protobuf:"bytes,1,opt,name=preservedToken,proto3" json:"preservedToken"` // 待失效的令牌
	UserID         string `protobuf:"bytes,2,opt,name=userID,proto3" json:"userID"`                 // 用户ID
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0a, 0x61, 0x65, 0x74, 0x69, 0x6d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x22, 0x5e, 0x0a,
	0x0c, 0x75, 0x73, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a,
	0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x53, 0x0a,
	0x0d, 0x75, 0x73, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x14,
	...
	0x64, 0x73, 0x22, 0x48, 0x0a, 0x0e, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x4c, 0x6f, 0x67, 0x6f, 0x75,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x11, 0x0a, 0x0f,
	0x66, 0x6f, 0x72, 0x63, 0x65, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22,
	0x25, 0x0a, 0x0d, 0x70, 0x61, 0x72, 0x73, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71,
	0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x76, 0x0a, 0x0e, 0x70, 0x61, 0x72, 0x73, 0x65, 0x54,
	...
	0x73, 0x22, 0x74, 0x0a, 0x12, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x26, 0x0a, 0x0e, 0x70, 0x72, 0x65, 0x73, 0x65,
	0x72, 0x76, 0x65, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0e, 0x70, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12,
	...
	,
...
var file_auth_auth_proto_goTypes = []interface{}{
	(*UserTokenReq)(nil),        // 0: aetim.auth.userTokenReq
	(*UserTokenResp)(nil),       // 1: aetim.auth.userTokenResp
	(*ForceLogoutReq)(nil),      // 2: aetim.auth.forceLogoutReq
	(*ForceLogoutResp)(nil),     // 3: aetim.auth.forceLogoutResp
	(*ParseTokenReq)(nil),       // 4: aetim.auth.parseTokenReq
	(*ParseTokenResp)(nil),      // 5: aetim.auth.parseTokenResp
	(*GetUserTokenReq)(nil),     // 6: aetim.auth.getUserTokenReq
	(*GetUserTokenResp)(nil),    // 7: aetim.auth.getUserTokenResp
	(*InvalidateTokenReq)(nil),  // 8: aetim.auth.invalidateTokenReq
	(*InvalidateTokenResp)(nil), // 9: aetim.auth.invalidateTokenResp
}
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: aetim.auth.Auth.userToken:input_type -> aetim.auth.userTokenReq
	6, // 1: aetim.auth.Auth.getUserToken:input_type -> aetim.auth.getUserTokenReq
	2, // 2: aetim.auth.Auth.forceLogout:input_type -> aetim.auth.forceLogoutReq
	4, // 3: aetim.auth.Auth.parseToken:input_type -> aetim.auth.parseTokenReq
	8, // 4: aetim.auth.Auth.invalidateToken:input_type -> aetim.auth.invalidateTokenReq
	1, // 5: aetim.auth.Auth.userToken:output_type -> aetim.auth.userTokenResp
	7, // 6: aetim.auth.Auth.getUserToken:output_type -> aetim.auth.getUserTokenResp
	3, // 7: aetim.auth.Auth.forceLogout:output_type -> aetim.auth.forceLogoutResp
	5, // 8: aetim.auth.Auth.parseToken:output_type -> aetim.auth.parseTokenResp
	9, // 9: aetim.auth.Auth.invalidateToken:output_type -> aetim.auth.invalidateTokenResp
...
func (c *authClient) UserToken(ctx context.Context, in *UserTokenReq, opts ...grpc.CallOption) (*UserTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.auth.Auth/userToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) GetUserToken(ctx context.Context, in *GetUserTokenReq, opts ...grpc.CallOption) (*GetUserTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.auth.Auth/getUserToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) ForceLogout(ctx context.Context, in *ForceLogoutReq, opts ...grpc.CallOption) (*ForceLogoutResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.auth.Auth/forceLogout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) ParseToken(ctx context.Context, in *ParseTokenReq, opts ...grpc.CallOption) (*ParseTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.auth.Auth/parseToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) InvalidateToken(ctx context.Context, in *InvalidateTokenReq, opts ...grpc.CallOption) (*InvalidateTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/aetim.auth.Auth/invalidateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_UserToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.auth.Auth/UserToken",
	}
...
func _Auth_GetUserToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.auth.Auth/GetUserToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Auth_ForceLogout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.auth.Auth/ForceLogout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Auth_ParseToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.auth.Auth/ParseToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Auth_InvalidateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aetim.auth.Auth/InvalidateToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
